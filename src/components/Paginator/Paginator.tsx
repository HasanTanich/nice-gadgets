      ...
      style={{
        width:
          numberOfPages.length < 4
            ? `${numberOfPages.length * 40 - 8 + 96}px`
            : "248px",
      }}
    >
      <button
      ...
      >
        <img
          src={currentPage === 1 ? Arrow : ArrowBlack}
      ...
      >
        {numberOfPages.map((item) => (
          <button
            key={item}
            type="button"
            className={`paginator-pageNumbersBox-pageNumber ${
              item === currentPage
                ? "paginator-pageNumbersBox-pageNumber--active"
                : ""
            }`}
      ...
      >
        <img
          src={currentPage === numberOfPages.length ? Arrow : ArrowBlack}
